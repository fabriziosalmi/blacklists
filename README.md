...
| Metric | Value |
|--------|-------|
| **Total Domains** | **3,094,991** |
| **Whitelisted** | 2,268 |
| **Sources** | 61 |
| **Daily Change** | +172,974 (+5.92%) |
| **Weekly Change** | +224,469 (+7.82%) |
| **Monthly Change** | +278,096 (+9.87%) |
