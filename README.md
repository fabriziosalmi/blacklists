...
| Metric | Value |
|--------|-------|
| **Total Domains** | **4,111,079** |
| **Whitelisted** | 2,269 |
| **Sources** | 61 |
| **Daily Change** | -153,977 (-3.61%) |
| **Weekly Change** | -794,090 (-16.19%) |
| **Monthly Change** | -718,711 (-14.88%) |
