...
| Metric | Value |
|--------|-------|
| **Total Domains** | **3,082,011** |
| **Whitelisted** | 2,268 |
| **Sources** | 61 |
| **Daily Change** | +18,425 (+0.60%) |
| **Weekly Change** | +192,750 (+6.67%) |
| **Monthly Change** | +284,714 (+10.18%) |
