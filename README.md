...
| Metric | Value |
|--------|-------|
| **Total Domains** | **4,645,183** |
| **Whitelisted** | 2,053 |
| **Sources** | 61 |
| **Daily Change** | +474,355 (+11.37%) |
| **Weekly Change** | +215,302 (+4.86%) |
| **Monthly Change** | +95,820 (+2.11%) |
