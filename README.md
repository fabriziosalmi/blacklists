...
| Metric | Value |
|--------|-------|
| **Total Domains** | **4,876,996** |
| **Whitelisted** | 2,059 |
| **Sources** | 50 |
| **Daily Change** | +11,906 (+0.24%) |
| **Weekly Change** | +219,386 (+4.71%) |
| **Monthly Change** | +183,081 (+3.90%) |
